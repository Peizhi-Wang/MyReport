# -*- coding: utf-8 -*-
"""
Created on Mon Aug  5 15:02:01 2019
...
dictionary = corpora.Dictionary(line.lower().split() for line in open('C:/Users/WCH/Desktop/try-DTM/testceshi.txt'))  
#print (dictionary)
stop_ids = [
...
print ("topicEvolution")
print(topicEvolution)
doc = ldaseq.doc_topics(1) # 查询指定文档的主题分布,此处为第一篇文档的主题分布

print ("########################################################")
corpusTopic = ldaseq.print_topics(time=2)  # 输出指定时期主题分布，此处第一个时期主题分布
print ("corpusTopic")
print(corpusTopic)
topicEvolution = ldaseq.print_topic_times(topic=2) # 查询指定主题在不同时期的演变，此处为第一个主题的
print ("topicEvolution")
print(topicEvolution)
doc = ldaseq.doc_topics(2) # 查询指定文档的主题分布,此处为第一篇文档的主题分布

print ("########################################################")
corpusTopic = ldaseq.print_topics(time=3)  # 输出指定时期主题分布，此处第一个时期主题分布
print ("corpusTopic")
print(corpusTopic)
topicEvolution = ldaseq.print_topic_times(topic=3) # 查询指定主题在不同时期的演变，此处为第一个主题的
print ("topicEvolution")
print(topicEvolution)
doc = ldaseq.doc_topics(3) # 查询指定文档的主题分布,此处为第一篇文档的主题分布